...
$(".btn-pepperonni").on("click", function (event) {
  ...
  if ($(".btn-pepperonni").hasClass("active")) {
    ...
    totalPrice += pepPrice;
    $("#price-list").append(
      '<li id="pepperoni"> Pepperoni ' + pepPrice + "₹" + "</li>"
    );
  }
...
$(".btn-green-peppers").on("click", function (event) {
  ...
  if ($(".btn-green-peppers").hasClass("active")) {
    ...
    totalPrice += greenPrice;
    $("#price-list").append(
      '<li id="green-pepper"> Green Pepper ' + greenPrice + "₹" + "</li>"
    );
  }
  $("strong").append(totalPrice);
  $("strong").append("₹");
...
$(".btn-mushrooms").on("click", function (event) {
  ...
  if ($(".btn-mushrooms").hasClass("active")) {
    ...
    totalPrice += mushPrice;
    $("#price-list").append(
      '<li id="mushroom"> Mushroom ' + mushPrice + "₹" + "</li>"
    );
  }
  $("strong").append(totalPrice);
  $("strong").append("₹");
...
$(".btn-crust").on("click", function (event) {
  ...
  if ($(".btn-crust").hasClass("active")) {
    ...
    totalPrice += crustPrice;
    $("#price-list").append(
      '<li id="crust"> Crust ' + crustPrice + "₹" + "</li>"
    );
  }
  $("strong").append(totalPrice);
  $("strong").append("₹");
...
$(".btn-sauce").on("click", function (event) {
  ...
  if ($(".btn-sauce").hasClass("active")) {
    ...
    totalPrice += saucePrice;
    $("#price-list").append(
      '<li id="sauce"> Sauce ' + mushPrice + "₹" + "</li>"
    );
  }
  $("strong").append(totalPrice);
  $("strong").append("₹");
